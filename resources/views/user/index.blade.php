									...
									<div class="row">
										<div class="col-md-12 col-lg-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('phone', null, ['id '=> 'phone',  'class' => 'form-control', 'placeholder' => '994411554', 'type' => 'email']) !!}
                                            </div>
                                            <div class="form-group form-floating-label">
                                                <label for="genero">Genero</label>
                                                {!! Form::select('genero',['feminino' => 'feminino', 'masculino' => 'masculino', 'outros' => 'outros'],null, ['id '=> 'selectFloatingLabel',  'class' => 'form-control input-border-bottom']) !!}
											</div>
